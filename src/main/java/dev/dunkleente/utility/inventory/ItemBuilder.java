package dev.dunkleente.utility.inventory;
...
public class ItemBuilder {
    ...
    public ItemBuilder name(String name) {
        return name(ColorUtil.parse(name));
    }
    ...
    public ItemBuilder skullOwner(String playerName){
        ...
        if (itemMeta != null) {
            Bukkit.getAsyncScheduler().runNow(Economy.getInstance(), e -> itemMeta.setOwnerProfile(Bukkit.getOfflinePlayer(UUID.fromString(playerName)).getPlayerProfile()));
        }
        itemStack.setItemMeta(itemMeta);
        return this;
    }
    ...
    public ItemBuilder potionType(PotionType type) {
        itemStack.editMeta(PotionMeta.class, meta -> meta.setBasePotionType(type));
    ...
    public ItemBuilder addContainerValue(String key, String value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(Economy.getInstance(), key), PersistentDataType.STRING, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
    ...
    public ItemBuilder addContainerValue(String key, int value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(Economy.getInstance(), key), PersistentDataType.INTEGER, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
    ...
    public ItemBuilder addContainerValue(String key, boolean value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(Economy.getInstance(), key), PersistentDataType.BOOLEAN, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
